 ...
 *
 * A responsive mobile header with menu toggle, back button support,
 * and custom right content slot. Features animated menu/close icon transition.
 *
 * @example
 * ```typescript
 * import { MobileHeader } from '@world-schools/ui-web'
 *
 * function MyApp() {
