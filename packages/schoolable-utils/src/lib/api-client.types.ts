/**
 * API Client Types for Schoolable Applications
 *
 * These types are used by the shared API client factory to provide
 * type-safe HTTP communication with the schoolable-nest-api backend.
 */
...
export interface ApiClientConfig {
   ...
   * @example 'schoolable' -> 'schoolable_access_token'
   * @default 'app'
   */
