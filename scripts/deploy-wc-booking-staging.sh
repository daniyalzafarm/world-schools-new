...
# Deploy wc-booking to Azure Container Apps (Staging)
# Usage: ./deploy-wc-booking-staging.sh [VERSION] [BUILD_ENV]
# Example: ./deploy-wc-booking-staging.sh 1.0.0 "NEXT_PUBLIC_CUSTOM_VAR=value"
...
APP_NAME="wc-booking"
IMAGE_NAME="wc-booking"
CONTAINER_APP_NAME="${CA_BOOKING_NAME}"
DOCKERFILE_PATH="apps/wc-booking/Dockerfile"
...
echo "=========================================="
echo "Deploying wc-booking to Staging"
echo "=========================================="
