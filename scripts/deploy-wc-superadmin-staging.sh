...
# Deploy wc-superadmin to Azure Container Apps (Staging)
# Usage: ./deploy-wc-superadmin-staging.sh [VERSION] [BUILD_ENV]
# Example: ./deploy-wc-superadmin-staging.sh 1.0.0 "NEXT_PUBLIC_CUSTOM_VAR=value"
...
APP_NAME="wc-superadmin"
IMAGE_NAME="wc-superadmin"
CONTAINER_APP_NAME="${CA_SUPERADMIN_NAME}"
DOCKERFILE_PATH="apps/wc-superadmin/Dockerfile"
...
echo "=========================================="
echo "Deploying wc-superadmin to Staging"
echo "=========================================="
