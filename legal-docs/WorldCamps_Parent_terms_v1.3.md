...
**Effective Date:** [TBC — to be inserted on publication]

These Customer Terms and Conditions constitute a legally binding agreement between World Schools Sarl ("**World Camps**") and any Customer using the World Camps platform. The full revision history of these Terms is maintained for internal counsel in the companion Annex A file (`WorldCamps_Parent_terms_AnnexA_v1.3.md`); material changes to these Terms will be notified to Customers in accordance with Section 24.2.
...
"Platform Fee" means the fee charged by World Camps to the Provider for use of the Platform infrastructure and booking services in respect of each Booking, which is included in the total Booking price displayed to the Customer at checkout. The Platform Fee is paid by the Provider out of the Booking proceeds and is not a separate charge to the Customer.
...
The total price payable for a Booking is the gross price displayed at checkout. This price includes the Platform Fee. The Platform Fee is charged by World Camps to the Provider for use of the Platform infrastructure and booking services. It is not a separate charge to you, and it is not remuneration for the delivery of any Programme.

### 7.2 Platform Fee

The Platform Fee is deducted at source from each payment processed by the Platform and is collected automatically via the payment infrastructure. The Platform Fee rate is a commercial matter between World Camps and the Provider. The Platform Fee is not separately invoiced to you.

### 7.3 Deposits and balance payments

Where a Booking is structured to require a deposit on formation of the Booking Contract and a balance payment at a later date, the payment schedule is displayed to you at checkout. The deposit is captured at the Acceptance Time in accordance with Section 5.2(d) and Section 7.4. Balance payments are automatically processed on the scheduled due date using the payment method on file. You are responsible for ensuring that your payment method is valid and has sufficient funds on the due date.
...
(c) *Capture on Acceptance.* On formation of the Booking Contract in accordance with Section 5.2(d), the authorisation hold is captured at the Acceptance Time. Where the Booking is structured as deposit-plus-balance, only the deposit portion is captured at the Acceptance Time; the balance is processed on the scheduled due date in accordance with Section 7.3.
...
(e) *Authorisation lifetime.* Card-network authorisation holds are subject to the card network's standard authorisation lifetime (commonly seven days). Where the Acceptance Window in respect of your Booking Request would extend close to or beyond that lifetime, the Platform may, with your prior consent, refresh the authorisation hold by placing a new authorisation in the same amount. Where consent to a refresh is not given and the authorisation lapses, your Booking Request lapses with it and no Booking Contract is formed.

### 7.5 Currency

Payments are processed in the currency displayed at checkout, which is determined by the Provider's country of operation. World Camps is not responsible for currency conversion costs, exchange rate fluctuations, or bank charges applied by your financial institution.
...
Each Booking is governed by the Cancellation Policy configured by the Provider for the relevant Programme. The applicable Cancellation Policy, together with its specific refund schedule, is displayed to you at checkout and recorded in your Booking confirmation.

### 8.2 Cancellation Policy framework

Providers select a Cancellation Policy from a range of standard tiers offered by World Camps (currently Flexible, Moderate, and Strict), or configure a Custom Cancellation Policy using World Camps's Cancellation Policy customisation tools. Each Cancellation Policy specifies, for defined periods before the Programme start date, the percentage of the Booking value that is refundable on cancellation by you. The standard tiers are described in greater detail in the Help Centre, but the contractually binding refund schedule for any Booking is the schedule displayed to you at checkout and recorded in your Booking confirmation.

### 8.3 Refund entitlement on cancellation by you

Where you cancel a Booking, your refund entitlement is determined by (i) the Cancellation Policy applicable to the Booking, and (ii) the number of days between the date your cancellation request is submitted through the Platform and the Programme start date. Subject to the 48-hour grace period in Section 8.4 and to Sections 8.6 and 8.7:

(a) the deposit paid at the time of Booking is non-refundable; and

(b) the refundability of the balance is governed by the applicable Cancellation Policy and is calculated by reference to the days-to-start band in effect at the time your cancellation request is submitted.

Nothing in this Section 8.3 limits any mandatory consumer right that cannot be excluded under applicable law.

### 8.4 Statutory right of withdrawal and 48-hour grace period
...
(b) *48-hour grace period.* If you cancel a Booking within forty-eight (48) hours of the formation of the Booking Contract in accordance with Section 5.2(d), you will receive a full refund of all amounts captured against your payment method in respect of the Booking (including the deposit and the Platform Fee), irrespective of the Cancellation Policy otherwise applicable to the Booking. The 48-hour grace period runs from the Acceptance Time and not from the time at which you submitted the Booking Request. This grace period is offered by World Camps on a voluntary basis as a platform-wide consumer goodwill policy, independently of and without prejudice to any mandatory consumer rights that apply in your jurisdiction of habitual residence.

### 8.5 Platform Fee treatment on cancellation

The Platform Fee is included in the total Booking price displayed to you at checkout. On cancellation:

(a) where you cancel within the 48-hour grace period, the Platform Fee is refunded in full;

(b) where you cancel after the 48-hour grace period (other than in circumstances giving rise to a Provider cancellation under Section 8.6 or a Force Majeure cancellation under Section 8.7), the Platform Fee is non-refundable;

(c) where the Provider cancels the Booking, the Platform Fee is refunded in full as part of the refund processed under Section 8.6; and

(d) the treatment of the Platform Fee on cancellation due to a Force Majeure Event is set out in Section 8.7.

### 8.6 Provider cancellations

If a Provider cancels a confirmed Booking, you are entitled to a full refund of all amounts paid for that Booking, including the deposit and the Platform Fee. World Camps will process the refund on behalf of the Provider as the Provider's authorised agent. World Camps is not financially liable for Provider cancellations but undertakes to enforce the refund obligation against the Provider in accordance with the Provider Terms.
...
(b) World Camps will, on behalf of the Provider, (i) suspend any pending payouts to the Provider in respect of the affected Bookings, and (ii) process a cash refund of all amounts paid by you in respect of the affected Booking, other than the Platform Fee (the treatment of which is set out in paragraph (c) below), to your original payment method;

(c) the Platform Fee will, as a general rule, be retained by World Camps in respect of Bookings cancelled due to a Force Majeure Event, on the basis that the platform service has been delivered. World Camps may, in its reasonable discretion, elect to refund the Platform Fee in respect of catastrophic, prolonged, or industry-wide Force Majeure Events; and
...
Any review, rating, or Content you submit to the Platform must be accurate, honest, and based on genuine first-hand experience. You must not submit false, misleading, defamatory, or commercially motivated reviews.
...
(a) *Ranking.* Where the Platform presents Programme listings in response to a search query, filter selection, or category navigation, the order in which Programmes are displayed (their "ranking") is determined by an automated process. The main parameters determining the ranking, and their general relative importance, are described in a dedicated disclosure page maintained in the Help Centre and accessible from each page on which a ranking is presented. The ranking parameters and their relative weights may be adjusted from time to time as the Platform evolves; the Help Centre page reflects the parameters in effect at any given time.
...
(ii) batch enquiry or batch quote-request functionality that allows you to send a single enquiry to multiple Providers simultaneously, with the Programme requirements and Child-related information necessary for each Provider to assess the enquiry.
...
The treatment of Bookings affected by a Force Majeure Event, including cash refunds and Platform Fee allocation, is governed by Section 8.7. Nothing in this Section 20 relieves Providers of their obligations to Customers under the relevant Booking Contract or under applicable consumer protection law.
...
In the event of a dispute, we encourage you to contact World Camps in the first instance at support@world-camps.org. We will endeavour to resolve complaints within fourteen (14) Business Days. If resolution is not achieved, you may be entitled to refer the dispute to an applicable alternative dispute resolution body or regulator, depending on your jurisdiction (see also Section 22.5).
...
World Schools Sarl, Route de la Bernadaz 5A, 1094 Paudex, Switzerland. General contact: support@world-camps.org. Legal notices: legal@world-camps.org.

---

*These Terms were last updated on [TBC — to be inserted on publication] and replace all prior versions.*

---

*Internal note: an accompanying Legal Review Annex (internal/counsel only) is maintained as a separate companion file at `WorldCamps_Parent_terms_AnnexA_v1.3.md`.*
