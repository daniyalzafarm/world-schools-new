...
export default function InfoRequestedPage() {
        ...
        <div className="w-full max-w-3xl">
          ...
          <div className="mb-8 rounded-xl border-2 border-[#FFB800] bg-[#FFF5E6] p-8">
            ...
            <p className="text-[#717171]">
              Our review team has requested additional information to process your application.
              Please review the message below and provide the requested details.
            </p>
          </div>
          ...
          <div className="mb-8 rounded-xl border border-[#E5E5E5] bg-white p-8">
            ...
            <p className="text-[#717171]">
              Please provide the requested information within <strong>7 days</strong> to avoid
              delays in processing your application. If you need more time, please contact our
              support team.
            </p>
          </div>
              ...
              <div className="text-sm text-[#717171]">
                ...
                <div className="mt-3 flex flex-col gap-2">
                  <a
                    ...
                    className="text-[#45F0B5] hover:underline"
                  >
