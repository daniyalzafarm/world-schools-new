/**
 * Support ticket types for wc-provider, mirroring backend DTOs.
 */
...
/** Message shape from GET /provider/support-tickets/:id/conversation. */
...
/** Create ticket payload sent to POST /provider/support-tickets */
...
/** List tickets query params for GET /provider/support-tickets/my */
