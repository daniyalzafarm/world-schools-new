  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      ...
      <div className="mb-8 rounded-xl border border-[#E5E5E5] bg-white p-8">
        <h2 className="mb-6 text-[24px] font-semibold text-[#222222]">What's being reviewed?</h2>
      ...
      <div className="mb-8 rounded-xl border border-[#E5E5E5] bg-white p-8">
        <h2 className="mb-4 text-[24px] font-semibold text-[#222222]">⏰ Estimated Review Time</h2>
