    ...
    <div className="max-w-4xl mx-auto flex flex-col gap-6">
      ...
      <div className="text-center flex flex-col gap-2">
        ...
        <p className="text-[16px] text-default-500 max-w-2xl mx-auto">
          Select your session type. This choice will determine how parents book your camp.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          <CardBody className="p-6 flex flex-col gap-2">
            ...
            <div className="flex items-start justify-between">
              <div className="shrink-0 w-12 h-12 rounded-xl bg-primary-100 dark:bg-primary-900 flex items-center justify-center text-[24px]">
                🗓️
              </div>
              {selectedType === 'flexible' && (
        ...
        >
          <CardBody className="p-6 flex flex-col gap-2">
            {/* Selection Indicator */}
            <div className="flex items-start justify-between">
              <div className="shrink-0 w-12 h-12 rounded-xl bg-secondary-100 dark:bg-secondary-900 flex items-center justify-center text-[24px]">
                📅
              </div>
              {selectedType === 'fixed' && (
                <div className="shrink-0 w-8 h-8 rounded-full bg-primary-500 flex items-center justify-center">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[13px] text-warning-700 dark:text-warning-300 leading-relaxed">
              Once you create your first session, you cannot change the session type. Choose based
              on how you want parents to book your camp.
            </p>
          </div>
        </div>
      </div>
