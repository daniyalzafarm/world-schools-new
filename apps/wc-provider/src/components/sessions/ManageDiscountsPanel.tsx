...
export function ManageDiscountsPanel({ campId, onClose }: ManageDiscountsPanelProps) {
  ...
  if (isLoading) {
    return (
      <div className="fixed inset-y-0 right-0 w-96 lg:w-[480px] bg-white border-l border-gray-200 shadow-lg z-50 flex items-center justify-center">
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-96 lg:w-[480px] bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 shadow-lg z-50 overflow-y-auto">
      {/* Header */}
