...
export function ImportCampsModal({ isOpen, onClose, onSuccess, providerId }: Props) {
    ...
    >
      <ModalContent>
        <ModalHeader className="flex flex-col gap-1">
          <h2 className="text-2xl font-bold">Import Camps</h2>
          <p className="text-sm font-normal text-default-500">
            {phase === 'results'
              ? 'Import complete'
              : 'Upload a CSV file to create multiple draft camps for this provider'}
          </p>
        </ModalHeader>
                ...
                <div>
                  ...
                  {result.failed > 0 && (
                    <p className="text-sm text-default-600">
                      {result.failed} camp{result.failed !== 1 ? 's' : ''} failed — see details
                      below
                    </p>
                  )}
                </div>
