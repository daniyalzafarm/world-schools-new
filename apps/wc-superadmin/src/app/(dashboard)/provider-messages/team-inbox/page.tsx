...
export default function ProviderTeamInboxPage() {
  return (
      ...
      <header className="flex flex-col gap-2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500">Collaborate on provider communication with shared visibility.</p>
          </div>
      ...
      <Card className="rounded-3xl border border-slate-200 dark:border-slate-800" shadow="sm">
        <CardHeader className="flex flex-col gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Chip color="primary" variant="flat">SLA met for 92% of threads</Chip>
          </div>
        ...
        <CardBody className="text-sm text-slate-500 space-y-4">
          <p>
            ...
            across provider relationships. Attachments and labels sync in real time for every teammate.
          </p>
