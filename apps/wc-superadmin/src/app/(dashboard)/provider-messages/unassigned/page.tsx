...
const REQUESTS = [
  { id: '1', subject: 'Need access to analytics', provider: 'BrightFuture Camps', waitTime: '2h 14m' },
  { id: '2', subject: 'Contract signature pending', provider: 'Lakeview Adventures', waitTime: '4h 02m' },
  { id: '3', subject: 'VAT invoice clarification', provider: 'World Explorers', waitTime: '6h 45m' },
]

export default function ProviderUnassignedInboxPage() {
  return (
    <section className="space-y-6">
      ...
      <Card className="rounded-3xl border border-slate-200 dark:border-slate-800" shadow="sm">
        <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <Input placeholder="Filter by provider or topic" radius="full" className="max-w-lg" />
          <Chip variant="flat" color="warning">Response time SLA: 8h</Chip>
        </CardHeader>
        <CardBody>
