...
const THREADS = [
  { id: '1', subject: 'Account verification issue', user: 'Sarah Johnson', unread: true },
  { id: '2', subject: 'Payment method update request', user: 'Michael Chen', unread: false },
  { id: '3', subject: 'Question about camp enrollment', user: 'Emma Williams', unread: false },
]

export default function UserMyInboxPage() {
  return (
            ...
            {THREADS.map(thread => (
              ...
              >
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-slate-500">{thread.user}</span>
                </div>
              </ListboxItem>
            ))}
          </Listbox>
