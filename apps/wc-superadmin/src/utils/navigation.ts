...
export const ROUTES: RouteConfig[] = [
  ...
  { path: '/payment-reviews', label: 'Payment Reviews', permission: 'billing.read' },
  { path: '/force-majeure', label: 'Force Majeure', permission: 'billing.write' },
  { path: '/provider-review', label: 'Provider Reviews', permission: 'providers.read' },
