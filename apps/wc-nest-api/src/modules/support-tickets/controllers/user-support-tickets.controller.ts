...
@ApiBearerAuth()
@Controller('user/support-tickets')
...
export class UserSupportTicketsController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Create a support ticket (parent)',
    description: 'Creates a support ticket with sourceApp=WC_BOOKING and requesterType=PARENT.',
  })
  async createTicket(
    ...
    const payload = {
      ...dto,
      sourceApp: SupportTicketSourceApp.WC_BOOKING,
      requesterType: SupportTicketRequesterType.PARENT,
      requesterUserId: user.id,
      requesterProviderId: undefined,
    }
  ...
  @Patch(':id/status')
  @ApiOperation({
    summary: 'Update my ticket status (parent)',
    description:
