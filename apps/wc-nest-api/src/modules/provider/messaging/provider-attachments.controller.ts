...
/**
 * Provider Attachments Controller
 *
 * App-specific wrapper for message attachment endpoints used by wc-provider app.
 * All endpoints are prefixed with /provider/messaging/attachments so the JWT strategy
 * uses wc_provider_access_token (cookie or x-access-token).
 */
